              ...
              >
                <div className="h-48 w-full flex justify-center mb-4 bg-gray-50 items-center rounded-xl overflow-hidden p-4">
                  <img
                    src={product.image}
                    alt={product.title}
                    className="max-h-full object-contain mix-blend-multiply mx-auto group-hover:scale-105 transition-transform duration-300"
                  />
                </div>
                <div className="flex flex-col grow">
                  <h2 className="mt-3 text-sm font-bold text-gray-800 md:text-base line-clamp-2 leading-tight group-hover:text-blue-800 transition-colors">
                    {product.title}
                  </h2>
                </div>
              </Link>
